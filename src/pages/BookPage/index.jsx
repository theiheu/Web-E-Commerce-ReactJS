...
const BookPage = () => {
  ...
  return (
    ...
    >
      <Content className="flex max-md:flex-col gap-4">
        <div className="w-1/4 max-md:w-full min-h-[300px] bg-white rounded-xl p-3">
        ...
        <div className="flex w-full max-sm:flex-col gap-4">
          <div className="w-2/3 max-md:w-2/3 max-sm:w-full min-h-[300px] bg-white rounded-xl p-3">
          ...
          <div className="w-1/3 max-sm:w-full max-md:w-1/3 min-h-[300px] flex flex-col bg-white rounded-xl p-3">
            ...
            <div className="w-full flex justify-center items-center gap-2 sm:flex-col">
              <Button size="large" type="primary" danger className="w-full">
                Mua ngay
              </Button>
              <Button size="large" className="w-full sm:mt-2">
                Thêm vào giỏ hàng
              </Button>
            </div>
          </div>
