  ...
  >
    ...
    >
      <Input.Password
        ...
        placeholder="••••••••"
        className="flex bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)]"
      />
    </Form.Item>
    <Form.Item
      label="Phone Number"
