...
const LoginPage = () => (
  <Form
    ...
    autoComplete="off"
    action="#"
    className="bg-white shadow-sm border border-gray-200 rounded-lg  max-w-md p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700 container mt-[50px] md:mt-[100px]"
  >
